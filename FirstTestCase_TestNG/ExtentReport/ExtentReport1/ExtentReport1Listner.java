...
//ExtentReport1.ExtentReport1Listner
import java.io.File;
...
public class ExtentReport1Listner implements ITestListener {
	...
	public void onTestStart(ITestResult result) {
		...
		test.log(LogStatus.PASS, result.getMethod().getMethodName() + " test is started");
	}
...
//	driver.get("https://www.google.com/");	
	reports = new ExtentReports("./test-output/ExtentReport-3-Sep-2024.html"); //. operator it directly refers project workspace note: here we can see extent report 
	}
